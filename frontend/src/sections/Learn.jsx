...
export default function Learn() {
  return (
    <section
      id="learn"
      className="relative scroll-mt-20 overflow-hidden border-t border-wine/10 bg-rose/15 px-6 py-24"
    >
      <div className="relative z-10 mx-auto max-w-6xl">
        <SectionLabel>Learn</SectionLabel>
        <h2 className="mt-4 max-w-2xl font-display text-3xl font-semibold text-ink md:text-4xl">
          PCOS isn&rsquo;t one thing
        </h2>
        <p className="mt-4 max-w-xl text-ink/70">
          It shows up differently depending on which signs are present. Tap a card to see which one
          sounds like you.
        </p>
